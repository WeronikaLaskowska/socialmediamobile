...
import Title from './features/dashboard/components/Title';
import {FontAwesomeIcon} from '@fortawesome/react-native-fontawesome';
import {faEnvelope} from '@fortawesome/free-regular-svg-icons';
import globalStyle from './assets/styles/globals';
import UserStory from './features/dashboard/components/UserStory';
import UserPost from './features/dashboard/components/UserPost';
    ...
    <SafeAreaView style={{flex: 1}}>
      <View style={globalStyle.header}>
        ...
        <TouchableOpacity style={globalStyle.messageIcon}>
          ...
          <View style={globalStyle.messageCounter}>
            <Text style={globalStyle.messageCounterText}>2</Text>
          </View>
        </TouchableOpacity>
      </View>
